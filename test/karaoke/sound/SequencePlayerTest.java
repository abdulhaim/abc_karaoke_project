...
public class SequencePlayerTest {
    ...
    public void testPlayPiece2() throws MidiUnavailableException, InvalidMidiDataException {
        ...
        player.addNote(piano, new Pitch('G'), startBeat+=(1.0 + 1.0), 1.0); //added rest
    ...
    public void testPlayPiece3() throws MidiUnavailableException, InvalidMidiDataException {
        ...
        player.addNote(piano, new Pitch('D'), startBeat+=4.0, 2.0);

        player.addEvent(startBeat, (Double beat) -> { System.out.print("ma - zing "); });
        player.addNote(piano, new Pitch('G'), startBeat +=2.0, 4.0);
        player.addNote(piano, new Pitch('B'), startBeat +=4.0, 1.0);
        player.addNote(piano, new Pitch('G'), startBeat +=1.0, 1.0);

        player.addEvent(startBeat, (Double beat) -> { System.out.print("grace! How "); });
        player.addNote(piano, new Pitch('B'), startBeat +=1.0, 4.0);
        player.addNote(piano, new Pitch('A'), startBeat+=4.0, 2.0);

        
        player.addEvent(startBeat, (Double beat) -> { System.out.print("sweet the "); });
        player.addNote(piano, new Pitch('G'), startBeat +=2.0, 4.0);
        player.addNote(piano, new Pitch('E'), startBeat +=4.0, 2.0);

        player.addEvent(startBeat, (Double beat) -> { System.out.print("sound That "); });
        player.addNote(piano, new Pitch('D'), startBeat +=2.0, 4.0);
        player.addNote(piano, new Pitch('D'), startBeat +=4.0, 2.0);
        ...
        player.addNote(piano, new Pitch('D').transpose(Pitch.OCTAVE), startBeat+=2.0, 6.0);
